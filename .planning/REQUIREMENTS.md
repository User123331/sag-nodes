...
- [x] **PKG-03**: Viewer components individually exportable for Next.js consumption
- [x] **PKG-04**: Dynamic import friendly — graph component loadable via next/dynamic with { ssr: false }
...
- Mapped to phases: 63
- Complete: 59
- Pending (gap closure): 4 (SHAR-01, STAT-02, VIS-03, VIS-04)
- Unmapped: 0
